                ...
                <div class="col-lg-8 tm-post-col">
                    <div class="tm-post-full">                    
						<?php
							...
							if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['editedPost']))
								{
									save();
								}
								else{echo 'dupa';}
							function save(){
								global $con;
								$content = $_POST["editedPost"];
								$postId = $_GET['postId'];
								if($con->query("UPDATE posts SET content = '$content', subject = '$_POST[subject]' WHERE id=$postId")==true)
									echo("Post edited successfully");
								else
									echo("Error while editing post");
							}
							$con->close();
							?>
					</div>
